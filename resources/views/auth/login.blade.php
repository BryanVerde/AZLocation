    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <!--<form method="POST" action="{{ route('login') }}">
                @csrf
                    <input class="fadeIn second" id="login" placeholder="User or Email" type="text" class="form-control{{ $errors->has('username') || $errors->has('email') ? ' is-invalid' : '' }}" name="login" value="{{ old('username') ?: old('email') }}" required autofocus>
                    ...
                    <input class="fadeIn third" placeholder="Password" id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required>
